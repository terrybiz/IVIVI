...
contras_criterion = losses.SupConLoss_HNM(opt.ins_temp)
...
for epoch in range(opt.nepoch):
    ...
    for i in range(0, data.ntrain, opt.batch_size):
        ...
        for iter_d in range(opt.critic_iter):
            ...
            # CONTRASITVE LOSS
            real_ins_contras_loss, hn_real, sel_real = contras_criterion(outz_real, input_label)
        ...
        fake_ins_contras_loss, hn_fake, sel_fake = contras_criterion(all_outz, torch.cat((input_label, input_label), dim=0))
